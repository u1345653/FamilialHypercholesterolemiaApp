function change(obj) {
	...
	if (selectedPegigree == 'pedigree1') {
		ped1Attributes.style.display = "block";
		ped2Attributes.style.display = "none";
		ped3Attributes.style.display = "none";
		ped4Attributes.style.display = "none";
		ped5Attributes.style.display = "none";
		ped6Attributes.style.display = "none";
		ped7Attributes.style.display = "none";
		ped8Attributes.style.display = "none";
		ped9Attributes.style.display = "none";
	}	else if (selectedPegigree == 'pedigree2') {
		ped2Attributes.style.display = "block";
		ped1Attributes.style.display = "none";
		ped3Attributes.style.display = "none";
		ped4Attributes.style.display = "none";
		ped5Attributes.style.display = "none";
		ped6Attributes.style.display = "none";
		...
		ped3Attributes.style.display = "block";
		ped2Attributes.style.display = "none";
		ped1Attributes.style.display = "none";
		ped4Attributes.style.display = "none";
		ped5Attributes.style.display = "none";
		...
		ped4Attributes.style.display = "block";
		ped2Attributes.style.display = "none";
		ped1Attributes.style.display = "none";
		ped3Attributes.style.display = "none";
		ped5Attributes.style.display = "none";
		...
		ped5Attributes.style.display = "block";
		ped2Attributes.style.display = "none";
		ped1Attributes.style.display = "none";
		ped3Attributes.style.display = "none";
		ped4Attributes.style.display = "none";
		...
		ped6Attributes.style.display = "block";
		ped2Attributes.style.display = "none";
		ped1Attributes.style.display = "none";
		ped3Attributes.style.display = "none";
		ped4Attributes.style.display = "none";
		...
		ped7Attributes.style.display = "block";
		ped2Attributes.style.display = "none";
		ped1Attributes.style.display = "none";
		ped3Attributes.style.display = "none";
		ped4Attributes.style.display = "none";
		...
		ped8Attributes.style.display = "block";
		ped2Attributes.style.display = "none";
		ped1Attributes.style.display = "none";
		ped3Attributes.style.display = "none";
		ped4Attributes.style.display = "none";
		...
		ped9Attributes.style.display = "block";
		ped2Attributes.style.display = "none";
		ped1Attributes.style.display = "none";
		ped3Attributes.style.display = "none";
		ped4Attributes.style.display = "none";
